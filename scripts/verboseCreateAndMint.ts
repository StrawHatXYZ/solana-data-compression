...
//   productLink: "https://amazon.com/sample-product",
//   discoverers: ["Alice", "Bob"],
// };

// // Append the user data to the Merkle tree
// await appendUserDataToTree(connection, payer, treeKeypair, sampleUserData);
...
import {
  ...
  // createTree, // Make sure to implement this function
} from "@/utils/helpers";

import {  createTree, appendUserDataToTree} from "@/utils/compression";
...
(async () => {
  ...
  await appendUserDataToTree(connection, payer, treeKeypair.publicKey ,treeKeypair, sampleUserData);
